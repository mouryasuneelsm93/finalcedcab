...
<thead><tr class="bg-primary"><th>Name</th><th>Distance</th><th>isAvailable</th><th>Action</th></tr></thead>
<tbody>
<?php
class approve
{
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo "<td><a href='' type='button' class='btn btn-primary'>Edit</a> <a href='location_del.php?id=$row[id]' type='button' class='btn btn-primary'>Delete</a></td></tr>";
