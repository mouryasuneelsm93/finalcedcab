...
<thead>
<tr class='bg-primary'>
<th>Ride_From</th><th>Ride_to</th><th>Ride_Date</th><th>Total_Distance</th><th>Luggage</th><th>Total_Fare</th><th>Action</th>
</tr>
</thead>";
echo "<tbody>";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo "<td><button type='button' class='btn btn-primary' onclick='window.print()'>invoice</button></tr>";
