...
echo "<thead><tr class='bg-primary'><th>Name</th><th>Email</th><th>Number</th><th>Date</th><th>Action</th></tr></thead>";
echo "<tbody>";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo "<td>".$row['Date']."</td>";
    echo "<td><a href='blockuser.php?sno=$row[S_No]' class='btn btn-primary'>block</a></tr>";
  }} 
   else {
    echo "0 results";
  }
